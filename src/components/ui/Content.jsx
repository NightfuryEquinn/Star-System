...
export default function Content({ planet, view, onSetView }) {
  ...
  return (
    <>
      <div className={`${ view ? "opacity-100 scale-y-100" : "opacity-0 scale-y-0 pointer-events-none" } absolute top-0 right-0 bottom-0 left-0 bg-black bg-opacity-75 ease-open duration-500 origin-center`}>
        <div className="p-8 md:p-12 md:px-20 h-full max-h-screen flex flex-col gap-y-8 md:gap-y-12 overflow-scroll">
          ...
          <button onClick={ onSetView } className="self-center md:scale-125">
