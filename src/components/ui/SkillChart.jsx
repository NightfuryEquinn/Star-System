  ...
  return (
    <>
      <div className="p-5 h-full flex flex-col gap-y-8">
        ...
        <h4 className="font-stellar-regular text-xl italic self-center">{thePlanetData?.quote}</h4>

        <div className="border-corner-only h-full">
            {thePlanetData?.skill.map((content, index) => {
              if(index >= startIndex && index < endIndex) {
                return( 
                  <div key={ index } className="border-corner-only-content m-2 font-stellar-light text-xl tracking-wide uppercase h-full flex flex-col content-center justify-evenly">
