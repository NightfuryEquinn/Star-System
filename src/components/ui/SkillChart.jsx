        ...
        <div data-augmented-ui="tl-clip br-clip both" className="cyber-border cyber-border-color p-10 md:px-16 md:py-10 h-full">
          {thePlanetData?.skill.map((content, index) => {
            if(index >= startIndex && index < endIndex) {
              return( 
                <div key={ index } className="m-3 md:mx-6 font-stellar-light text-xl md:text-2xl text-black tracking-wide uppercase h-full flex flex-col gap-y-5 content-center justify-evenly">
                  ...
                  <div className="flex flex-col gap-y-3">
                    ...
                    <div className={`w-full text-white bg-black bg-opacity-50 text-center rounded-xl ${ view && 'animate-fade-left'} animate-delay-[0.6s]`}>
                  ...
                  <div className="flex flex-col gap-y-3">
                    ...
                    <div className={`w-full text-white bg-black bg-opacity-50 text-center rounded-xl ${ view && 'animate-fade-left'} animate-delay-[1.0s]`}>
